      ...
      <View style={styles.searchBarContainer}>
        <View style={[styles.searchBar, { backgroundColor: theme.colors.surface }]}>
          <TouchableOpacity onPress={() => navigation.goBack()}>
            <MaterialCommunityIcons name={isRTL ? 'arrow-right' : 'arrow-left'} size={24} color={theme.colors.outline} />
          </TouchableOpacity>
          <TextInput
...
const styles = StyleSheet.create({
  ...
  recentHeader: { justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  chipsContainer: { flexWrap: 'wrap', gap: 8 },
